...
package com.steven.testassistant.screenrecorder;
...
public class Const {
    ...
    static final String SCREEN_RECORDING_START = "com.steven.testassistant.screenrecorder.services.action.startrecording";
    static final String SCREEN_RECORDING_PAUSE = "com.steven.testassistant.screenrecorder.services.action.pauserecording";
    static final String SCREEN_RECORDING_RESUME = "com.steven.testassistant.screenrecorder.services.action.resumerecording";
    static final String SCREEN_RECORDING_STOP = "com.steven.testassistant.screenrecorder.services.action.stoprecording";
    static final String SCREEN_RECORDER_VIDEOS_LIST_FRAGMENT_INTENT = "com.steven.testassistant.screenrecorder.SHOWVIDEOSLIST";
    ...
    public static final String DEFAULT_VIDEO_FILE_PATH = Environment.getExternalStorageDirectory() + File.separator + Content.APP_ROOT_DIR+File.separator + Const.APPDIR;
