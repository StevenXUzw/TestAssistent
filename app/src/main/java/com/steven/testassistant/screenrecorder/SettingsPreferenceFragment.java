...
//import com.tinno.autotesttool.R;
//import com.tinno.autotesttool.screenrecorder.folderpicker.FolderChooser;
//import com.tinno.autotesttool.screenrecorder.folderpicker.OnDirectorySelectedListerner;

import com.steven.testassistant.R;
import com.steven.testassistant.screenrecorder.folderpicker.FolderChooser;
import com.steven.testassistant.screenrecorder.folderpicker.OnDirectorySelectedListerner;
...
public class SettingsPreferenceFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener
        , PermissionResultListener, OnDirectorySelectedListerner, ScreenRecorderActivity.AnalyticsSettingsListerner {
...
//    private CheckBoxPreference usageStats;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String defaultSaveLoc = (new File(Const.DEFAULT_VIDEO_FILE_PATH)).getPath();
...
//        if (getActivity() != null && getActivity() instanceof ScreenRecorderActivity) {
//            ((ScreenRecorderActivity) getActivity()).setupAnalytics();
//        }
//    }
}
