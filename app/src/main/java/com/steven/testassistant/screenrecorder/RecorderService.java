...
import com.steven.testassistant.common.Utils.NotificationUtil;
import com.steven.testassistant.common.Utils.RomUtil;
...
//        notificationChannels.add(shareNotificationChannel);
    ...
    private NotificationCompat.Builder createRecordingNotification(NotificationCompat.Action action) {
        ...
        NotificationCompat.Builder notification = new NotificationCompat.Builder(this, NotificationUtil.channelId)
                ...
                .addAction(R.drawable.ic_notification_stop, getResources().getString(R.string.screen_recording_notification_action_stop),
                        precordStopIntent);
        if (action != null && !RomUtil.isMiui())//miui只能显示一个action，就只显示stop好了
    ...
    private void showShareNotification(){
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this, 0,
                new Intent(this, ScreenRecorderActivity.class).setAction(Const.SCREEN_RECORDER_VIDEOS_LIST_FRAGMENT_INTENT), PendingIntent.FLAG_UPDATE_CURRENT);

        NotificationCompat.Builder shareNotification = new NotificationCompat.Builder(this, NotificationUtil.channelId)
